...
NSString * const kDataManagerBundleName = @"Buy_Online";
NSString * const kDataManagerModelName = @"Buy_Online";
NSString * const kDataManagerSQLiteName = @"Buy_Online.sqlite";
